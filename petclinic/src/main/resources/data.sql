INSERT INTO USERS VALUES('user1','{bcrypt}$2a$10$w6L1bNvvkc/kSCGnwP8l8OyPs7JS7DtHRRYdiYenLRf/oxF/wAt3q',TRUE);
INSERT INTO USERS VALUES('user2','{bcrypt}$2a$10$oxoRqOeW29Njv81Ok.bHJ.k7tY.0hyk/VZD4NWp1HV4gD.1V4XQuu',TRUE);
INSERT INTO USERS VALUES('user3','{bcrypt}$2a$10$nRW7BAWkA6cXqoezyux/8uzG5Y9yoMzewAPqlXFMmrVFb.V1eth7a',TRUE);
...
INSERT INTO t_owner(id,first_name,last_name) values (1,'Zeynep','Ferit');
...
INSERT INTO t_pet(id,name,birth_date,owner_id) values (1,'Minnoş','2005-09-07',1);
